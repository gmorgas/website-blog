...
@endsection
@section('tag')
    @lang('bee.keywords'), {{ $content->tags }}
@endsection
@section('title')
    @lang('bee.title')
@endsection
@section('content')
    ...
    <div class="contentWidth">
        <div class="navUp">
            <a href="/">@lang('bee.start')</a> >> <a href="{{ env('APP_URL').'/'.Lang::get('route.bee') }}">@lang('main.bee')</a> >> <a href="{{ env('APP_URL').'/'.Lang::get('route.bee').'/'.$content->slug }}">{{ $content->subject }}</a>
