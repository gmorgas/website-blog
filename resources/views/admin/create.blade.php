...
<div class="content">
            ...
            <hr>
            {!! Form::open(array('route' => 'store', 'data-parsley-validate' => '', 'files' => true)) !!}
            {{ Form::label('title', 'Title:') }}
            {{ Form::text('title', null, array('class' => 'form-control', 'style' => 'width: 80%;', 'required' => '', 'maxlength' => '255')) }}

            {{ Form::label('slug', 'Slug:') }}
            {{ Form::text('slug', null, array('class' => 'form-control',  'style' => 'width: 80%;', 'required' => '', 'minlength' => '5', 'maxlength' => '255')) }}
    ...
    {{ Form::text('tags', null, array('class' => 'form-control', 'style' => 'width: 80%;', 'required' => '', 'maxlength' => '255')) }}

            {{ Form::label('body', "Post Body:") }}
            {{ Form::textarea('body', null, array('class' => 'form-control')) }}

            {{ Form::submit('Stwórz post', array('class' => 'btn btn-success ', 'style' => 'margin-top: 20px;')) }}
            {!! Form::close() !!}
